...
app.get('/api/reviews', (req, res) => {
  // Your code here
  res.json(`${req.method} review request received`);
  console.info(req.rawHeaders);
  console.info(`${req.method} review request received`);
});
...
app.get('/api/upvotes', (req, res) => {
  // Your code here
  res.json(`${req.method} upvotes request received`);
  console.info(req.rawHeaders);
  console.info(`${req.method} upvotes request received`);
